                ...
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="team-box">
                      <div className="image">
                        <a href="team.html">
                          <img src="https://themesflat.co/html/cyfoniihtml/assets/images/layouts/team-01.png" alt="" />
                        </a>
                      </div>
                  ...
                  <div className="swiper-slide">
                    <div className="team-box">
                      <div className="image">
                        <a href="team.html">
                          <img src="https://themesflat.co/html/cyfoniihtml/assets/images/layouts/team-02.png" alt="" />
                        </a>
                      </div>
                      <div className="content">
                        <a href="team.html" className="h5 name">
                  ...
                  <div className="swiper-slide">
                    <div className="team-box">
                      <div className="image">
                        <a href="team.html">
                          <img src="https://themesflat.co/html/cyfoniihtml/assets/images/layouts/team-03.png" alt="" />
                        </a>
                      </div>
                      <div className="content">
                        <a href="team.html" className="h5 name">
                  ...
                  <div className="swiper-slide">
                    <div className="team-box">
                      <div className="image">
                        <a href="team.html">
                          <img src="https://themesflat.co/html/cyfoniihtml/assets/images/layouts/team-04.png" alt="" />
                        </a>
                      </div>
                      <div className="content">
                        <a href="team.html" className="h5 name">
              ...
              >
                ...
                <div className="swiper brands-swiper">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <a href="#">
                        <img src="https://themesflat.co/html/cyfoniihtml/assets/images/logo/brand-01.png" alt="" />
                      </a>
                    </div>
                    <div className="swiper-slide">
                      <a href="#">
                        <img src="https://themesflat.co/html/cyfoniihtml/assets/images/logo/brand-02.png" alt="" />
                      </a>
                    </div>
                    <div className="swiper-slide">
                      <a href="#">
                        <img src="https://themesflat.co/html/cyfoniihtml/assets/images/logo/brand-03.png" alt="" />
                      </a>
                    </div>
                    <div className="swiper-slide">
                      <a href="#">
                        <img src="https://themesflat.co/html/cyfoniihtml/assets/images/logo/brand-04.png" alt="" />
                      </a>
                    </div>
                    <div className="swiper-slide">
                      <a href="#">
                        <img src="https://themesflat.co/html/cyfoniihtml/assets/images/logo/brand-05.png" alt="" />
                      </a>
                    </div>
                    <div className="swiper-slide">
                      <a href="#">
                        <img src="https://themesflat.co/html/cyfoniihtml/assets/images/logo/brand-06.png" alt="" />
                      </a>
                    </div>
                  </div>
                </div>
