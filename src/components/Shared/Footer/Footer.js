...
const Footer = () => {
  ...
  useEffect(() => {
    fetch(`https://nft-seo-server.vercel.app/footer-links`)
      .then((res) => res.json())
  ...
  const newsLetter = (event) => {
    ...
    const url = `https://nft-seo-server.vercel.app/add-newsLetter/`;
    fetch(url, {
      method: "POST",
      headers: {
                  ...
                  <div className="right">
                    <div className="top">
                      <ul className="widget">
                        ...
                        <li>
                          {social.map((e) => (
                            <div className="list-social list-socials">
                              <li>
                                <Link to={e.facebook}>
                                  <svg
                                    width={9}
                      ...
                      <div className="widget">
                        ...
                        <form onSubmit={newsLetter} className="form">
