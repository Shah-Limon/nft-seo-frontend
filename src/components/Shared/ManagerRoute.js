...
const ManagerRoute = ({ children }) => {
  ...
  return isAdminOrManager ? (
    ...
    <div className="text-center payment-setting" data-aos="fade-up" data-aos-duration={2000}><h4>You are not authorized to access this page.<br></br>(your are not admin or Manager)</h4></div>
  );
};
