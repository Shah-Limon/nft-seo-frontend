    ...
    <>
      ...
      <div className="max-w-screen-lg mx-auto p-5">
        <div className="grid grid-cols-1 md:grid-cols-12 border">
          <div className="bg-gray-900 md:col-span-4 p-10 text-white">
            ...
            <p className="mt-4 leading-7 text-gray-200">
              If you have any questions, comments, or suggestions, we would love
              to hear from you.
            </p>
            <div className="flex items-center mt-5">
              ...
              <span className="text-sm">
                {footerAddress.map((phone) => phone.footerAdress)}
              </span>
            </div>
            <div className="flex items-center mt-5">
              <svg
              ...
              <span className="text-sm px-1">
                {footerAddress.map((email) => email.footerEmail)}
              </span>
            </div>
            <div className="flex items-center mt-5">
              <svg
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z"
              ...
              <span className="text-sm">
                {" "}
                {footerAddress.map((phone) => phone.footerPhone)}
              </span>
            </div>
            <div className="flex items-center mt-5">
              <svg
          ...
          <form className="md:col-span-8 p-10" onSubmit={handleContact}>
