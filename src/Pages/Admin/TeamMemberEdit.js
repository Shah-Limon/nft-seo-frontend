...
const TeamMemberEdit = () => {
  ...
  useEffect(() => {
    fetch(`https://nft-seo-server.onrender.com/team/${id}`)
      .then((res) => res.json())
  ...
  const updateTeam = async (event) => {
    ...
    const url = `https://nft-seo-server.onrender.com/team/${id}`;
    fetch(url, {
      method: "PUT",
      headers: {
  ...
  return (
    <div className="payment-setting mb-30" data-aos="fade-up" data-aos-duration={2000}>
