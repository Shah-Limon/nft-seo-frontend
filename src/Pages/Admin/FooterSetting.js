...
const FooterSetting = () => {
  ...
  /* footer about */
  useEffect(() => {
    fetch(`https://nft-seo-server.vercel.app/footer-about`)
      .then((res) => res.json())
  ...
  const handleFooterAbout = (event) => {
    ...
    const url = `https://nft-seo-server.vercel.app/footer-about`;
    fetch(url, {
      method: "POST",
      headers: {
  ...
  /* footer Address */
  useEffect(() => {
    fetch(`https://nft-seo-server.vercel.app/footer-address`)
      .then((res) => res.json())
  ...
  const handleFooterAddress = (event) => {
    ...
    const url = `https://nft-seo-server.vercel.app/footer-address`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
  ...
  /* Social Address */
  useEffect(() => {
    fetch(`https://nft-seo-server.vercel.app/footer-social`)
      .then((res) => res.json())
  ...
  const handleFooterSocial = (event) => {
    ...
    const url = `https://nft-seo-server.vercel.app/footer-social`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
  ...
  /* Copy Right */
  useEffect(() => {
    fetch(`https://nft-seo-server.vercel.app/footer-copyright`)
      .then((res) => res.json())
  ...
  const handleCopyright = (event) => {
    ...
    const url = `https://nft-seo-server.vercel.app/footer-copyright`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
