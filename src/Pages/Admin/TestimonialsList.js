...
const TestimonialsList = () => {
  ...
  useEffect(() => {
    fetch(`https://nft-seo-server.vercel.app/testimonials`)
      .then((res) => res.json())
  ...
  const handleTestimonials = (event) => {
    ...
    const url = `https://nft-seo-server.vercel.app/testimonial`;
    fetch(url, {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    fetch(`https://nft-seo-server.vercel.app/testimonials-title/`)
      .then((res) => res.json())
